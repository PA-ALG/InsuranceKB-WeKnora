...
- [ ] Add entry tests proving preparation query bypasses Active directory fetch, preserves the same candidate across refresh, and displays DRAFT as 待审核 and READY as 已审核但未发布. Normal G1/G2 modes remain unchanged.
