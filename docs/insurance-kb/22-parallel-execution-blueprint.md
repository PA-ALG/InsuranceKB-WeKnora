...
- **Wave 2（三版 2026-07-18，规格复审完成（PR #12 已合入，2026-07-18），按 L4 依赖顺序可认领，均为正式 delta 过 strict）**：009（混源防护+冻结投影扩展合同，010 域段后启动）、011（三方对账+typed provider+持久基准，可先行，迁移 0010）、012（断言级绑定+SnapshotQA，010 域段完成后）；
