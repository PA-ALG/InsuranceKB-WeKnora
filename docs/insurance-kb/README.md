...
> [!IMPORTANT]
> **当前执行入口（2026-08-31）**：先读根目录 [`AGENTS.md`](../../AGENTS.md)，
> 再读 [`HANDOFF.md`](../../HANDOFF.md)、
> [MVP-815 工程接手卡](26-mvp-815-engineering-handoff.md) 与当前任务适用的
> OpenSpec。下列 2026-07 Authority ADR、Amendment 2 和 V3 设计保留为架构来源，
> 不能覆盖当前入口与已验收状态。
>
...
初始版本产出于 2026-07-11 架构讨论定稿后。新人按上述当前入口阅读；00～25
用于补充背景，历史正文不能覆盖当前 OpenSpec、HANDOFF 与 main 身份。
...
| [14-deployment-runbook.md](14-deployment-runbook.md) | 旧 D0 部署合同与验收清单 | ⛔ HISTORY-ONLY；Projector 拓扑已 superseded |
| [15-solutions-traceability.md](15-solutions-traceability.md) | 七类北极星核心问题的能力闭环与当前落点；保留 2026-07-12 历史九问追溯 | ✅ |
| [16-roadmap.md](16-roadmap.md) | 2026-07 D0/C0/W0/CAP0 与 Milestone Roadmap | ⛔ HISTORY-ONLY；不代表当前排期 |
...
| [22-parallel-execution-blueprint.md](22-parallel-execution-blueprint.md) | 2026-07 生产架构小 PR 并行 DAG、migration lane、Owner 与评审门 | ⛔ HISTORY-ONLY；不代表当前执行队列 |
| [23-mvp-control-board.md](23-mvp-control-board.md) | 2026-07 D0 控制板、当时门禁与决策记录 | ⛔ HISTORY-ONLY；当前状态见 HANDOFF/OpenSpec 120 |
...
| [26-mvp-815-engineering-handoff.md](26-mvp-815-engineering-handoff.md) | MVP-815 最终代码地图、演示入口、验证和 C4 接手卡 | ✅ 当前工程接手入口 |
| [27-mvp-815-repository-cleanup.md](27-mvp-815-repository-cleanup.md) | 完整归档、保护项、分阶段 worktree 清理与恢复规则 | ✅ 当前清理依据 |
| [schema-baseline/](schema-baseline/) | 机器可读字段基线（13 个 YAML + extensions-v1.1，转自业务方 2026-07-10 Excel） | ✅ |

权威分工：[`AGENTS.md`](../../AGENTS.md)（贡献规则）·
[`HANDOFF.md`](../../HANDOFF.md)（当前状态）·
[OpenSpec 120](../../openspec/changes/120-schema-wiki-medical-596-1-mvp/)（MVP 合同）·
[26 号接手卡](26-mvp-815-engineering-handoff.md)（工程与 C4 起点）·
[Authority ADR](../superpowers/specs/2026-07-29-weknora-sole-serving-active-release-authority-adr.md) +
[Amendment 2](../superpowers/specs/2026-07-29-enterprise-llm-wiki-authority-amendment-2.md)（serving 架构来源）。
