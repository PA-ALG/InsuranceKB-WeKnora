...
| 052 | material-profile-template-binding | 🚧 PR #80 Draft；KCA4 补正已本地验证、未提交 | ProductVersion 596-1 三 PDF 的薄 MaterialProfile 绑定层；含 parser-neutral default + 至多一次 bounded upgrade policy，复用现有 TemplatePackage resolver，零 migration |
| 053+ | （空闲） | | 先占号再开目录 |
