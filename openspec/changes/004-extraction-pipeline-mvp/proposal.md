...
> [!CAUTION]
> **历史、不可执行、production-disabled。** 项目权利人已确认本 change 所依赖的 LLM-wiki-black/routing/cleaning 为第一方资产；旧勾选仍只证明当时测试范围，不构成当前架构或生产准入。027 未硬封强/未知模型、028 未按新运行时重构、030/适用 admission 未验收前，禁止运行本管道产生真实候选、ChangeSet 或 release。后续迁移必须记录 provenance，并以 027/028 新规格为准。
