...
状态：设计已由业务方于 2026-07-14 确认并完成复审；T1～T6 已实施，PR #9 implementation commit `a70bf025` 的 deterministic 与 PostgreSQL 16 外部门禁通过（PG JUnit `tests=2 skipped=0`）；T7 的代码/Runbook/report/本地门禁已完成，仅余真实 WeKnora live。018 依赖已合入的 016/017，并独占 migration `0005`。
