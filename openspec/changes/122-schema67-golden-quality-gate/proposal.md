...
This change is plan/OpenSpec only. It performs no provider, Golden generation/scoring,
database, WeKnora, migration, Draft, review, activation or deployment action.
