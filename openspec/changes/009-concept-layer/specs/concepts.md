...
- C3.4 **混源防护**（同事 WeKnora 实证反馈 2026-07-16：原生 wiki 概念页把 12 个产品来源聚成单一解释，不可作产品事实）：概念主页"定义区"只允许术语表/审核口径来源，**不得合成任何产品特定事实值**；产品事实只出现在差异表行内（行=单一产品，值=该产品 published Claim+证据角标）；QA/MCP 取数一律走产品 Claim/快照，不得引用概念页正文。
