...
| G3-R4 批次软件 | C设计2及修订7多行兼容bounded tests通过；来源回执设计8待闭合 | batch-c-design2-final-verification.json；独立56/root A+C73、ruff/strict mypy PASS；历史原日志保留 | 5efe84b5a；exact source/test SHA见receipt；新多行复现另存 | BLOCKED（当前来源回执兼容8；多行修复PASS） |
...
| 维度 | 状态 | 证据与边界 |
|---|---|---|
| software | PASS（A/B）；BLOCKED（C当前来源回执/D） | catalog-root-integration-verification.json；C design2独立复核通过；修订7 C/common独立81项及正文/身份probe PASS；D actual134/342及当前来源回执兼容8未闭合 |
