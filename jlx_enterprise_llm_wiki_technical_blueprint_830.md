...
CURRENT_ENGINEERING_GATE=BA0_PLAN_READY_AWAIT_EXECUTION_AUTHORIZATION
...
`docs/superpowers/plans/2026-09-04-830-ba0-local-build-reuse.md`。G2 必须等待
BA0 `PASS` 后再次取得用户明确启动授权。
