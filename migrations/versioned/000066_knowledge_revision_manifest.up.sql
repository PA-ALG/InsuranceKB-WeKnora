DO $$ BEGIN RAISE NOTICE '[Migration 000066] Creating revision manifest contract...'; END $$;
...
DO $$ BEGIN RAISE NOTICE '[Migration 000066] Revision manifest contract ready'; END $$;
