DO $$ BEGIN RAISE NOTICE '[Migration 000066 down] Removing revision manifest contract...'; END $$;
...
DO $$ BEGIN RAISE NOTICE '[Migration 000066 down] Revision manifest contract removed'; END $$;
