...
func TestSchemaWikiContainerDoesNotInjectNilCitationPort(t *testing.T) {
	...
	require.Contains(t, source, "NewSchemaWikiCitationPorts")
	require.Contains(t, source, "DecodeSchemaWikiCitationTokenSigningRing")
	require.Contains(t, source, "NewConceptSourceAuthorityService830G2")
	require.Contains(t, source, "ConceptSourceAuthorityVerifier830G2 = conceptSource")
