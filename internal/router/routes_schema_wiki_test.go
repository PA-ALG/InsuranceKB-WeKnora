...
func TestSchemaWikiRoutesDeclareExactScopedPrefixAndRetrievePolicy(t *testing.T) {
	...
	require.True(t, paths[http.MethodGet+" /api/v1/knowledgebase/:kb_id/wiki/release-scopes/:space_id/raw/:raw_kb_id/schema/concept-pages/:member_id"])
	require.True(t, paths[http.MethodGet+" /api/v1/knowledgebase/:kb_id/wiki/release-scopes/:space_id/raw/:raw_kb_id/schema/concept-pages/:member_id/citations/:citation_id/preview"])
