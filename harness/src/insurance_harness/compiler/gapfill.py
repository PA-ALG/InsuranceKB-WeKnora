...
from .prompts import GAPFILL_SYSTEM, build_gapfill_user
from .routing_data import FIELD_EVIDENCE_KEYWORDS, FIELD_NAME_ALIASES
...
async def gapfill_field(
    ...
    if not candidates:
        return _unknown(field, doc="", reason="no_candidate_sections")
    ...
    return _unknown(field, doc="", reason="not_found")
