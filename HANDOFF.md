...
> 最后更新：2026-07-21（OpenSpec 021 已随 PR #23、merge `cfefcc9b` 合入 main；020 T1 的 PR #24 合并前硬化已关闭四项 P1，clean-SHA canonical admission 仍按设计 BLOCKED。最新本机证据为 focused 700、全仓 deterministic 2607、Ruff/mypy/OpenSpec；T2～T7 未运行，只有刷新为 READY 后才允许真实模型调用；见 0j/0k/B22/B23。）
