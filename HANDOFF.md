...
> 最后更新：2026-07-18（018 已随 PR #9 合入 `main`（merge `b093a447`）；**008 工作台 PR #15、010 T1~T4 PR #14、wave2 规格 PR #12 均已合入 main**——当前 main 含 018/023/008/010-T1~T4/wave2 三版规格；009/011/012 规格复审完成可按 L4 依赖认领；015 飞轮 PR #18 待复核。正式 GitHub exact-SHA live 的 run URL、JUnit 与 cleanup 证据记录在收尾 PR 的 check/comment，不在提交后改写 head）
